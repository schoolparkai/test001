...
#삼행간 연쇄중첩형 8~8~8 -성공
words = r"\b\w*?(\w{8,})\w*?\b.{1,100}?" + "     " +  r".{1,130}?\b\w*?\1\w*?\b.{1,130}?"+ "     " +  r".{1,130}?\b\w*?\1\w*?\b.{1,130}?"

#삼행간 연쇄중첩형 2항목 (4)(4)~(4)(4)~(4)(4) -성공
words = r"\b\w*?(\w{3,3})\w*?\b.{1,10}?\b\w*?(\w{1,1})\w*?\b.{1,100}?" + "     " + \
    r".{1,130}?\b\w*?\1\w*?\b.{1,10}?\b\w*?\2\w*?\b.{1,130}?" + \
        "     " + r".{1,130}?\b\w*?\1\w*?\b.{1,10}?\b\w*?\2\w*?\b.{1,130}?"

#words =r"\b\w*(\w{3,})(\w)\w*\b(?:(?<!\s{5})\s{5}(?!.\s{5}))\b\w\2(\w{3,})(\w)\w*\b\W{0,5}\b\w*\4(\w{3,})(\w)\w*\b\W{0,5}\b\w*\6(\w{3,})\w*\b"

#삼행간 연쇄중첩형 종결어미 반복 - 실패- 다시 시도해 볼 것
words = r"\b\w*?(\w{2,})\w*?\b\w*?" + "     " + \
    r".{1,330}?\b\w*?\1\w*?\b\w*?" + "     " + r".{1,330}?\b\w*?\1\w*?\b\w*?"

#삼행간 계단식 연쇄 4~4~4 
words = r"\b\w*?(\w{6,})\w*?\b.{1,100}?" + "     " + \
    r".{1,130}?\b\w*?\1\w*?\b.{1,130}?\b\w*?(\w{6,})\w*?\b.{1,130}?" + \
    "     " + r".{1,130}?\b\w*?\2\w*?\b.{1,130}?"


belong = "장외_3장간_계단식_연쇄중첩_"
words_han ="_6_6_음소이상"
...
try:
    for e_f in data_files:
        ...
        with codecs.open(e_f,"r", encoding="utf-16") as f:
            ...
            f_lines = [line010203,line03_original]
